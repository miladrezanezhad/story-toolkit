...
<p dir="rtl">
Story Toolkit ابزارهایی برای ساخت شخصیت، تولید پیرنگ، نوشتن دیالوگ، جهان‌سازی و تحلیل انسجام داستان ارائه می‌دهد. 
<strong>🎉 جدید در نسخه 2.2.3:</strong> استحکام امنیتی با ۷۶ تست امنیتی (۱۰۰٪ پاس) و رفع آسیب‌پذیری‌های حیاتی.
</p>
