...
Story Toolkit ابزارهایی برای ساخت شخصیت، تولید پیرنگ، نوشتن دیالوگ، جهان‌سازی و تحلیل انسجام داستان ارائه می‌دهد. **🎉 جدید در نسخه 2.2.2:** ابزار خط فرمان کامل و قالب‌های آماده داستان!
...
| نسخه | ویژگی‌ها | پایتون |
|------|----------|--------|
| **2.2.2** | ابزار خط فرمان | 3.11+ |
| 2.2.1 | قالب‌های آماده (5 قالب) | 3.11+ |
| 2.2.0 | خروجی چندفرمتی (PDF, EPUB, HTML) | 3.11+ |
| 2.1.0 | حافظه SQLite | 3.11+ |
| 2.0.0 | لایه هوش مصنوعی | 3.11+ |
| 1.0.0 | ویژگی‌های هسته | 3.8+ |
...
## ✨ نکات برجسته نسخه 2.2.2

| ویژگی | توضیح |
|-------|-------|
| 🎯 **نشان‌ها** | Python 3.11+، مجوز، نسخه 2.2.2 |
| 🤖 **پشتیبانی از LLM** | OpenAI، Anthropic، مدل‌های محلی |
| 💾 **حافظه** | SQLite دائمی |
| 📄 **خروجی‌ها** | PDF، EPUB، HTML، Bionic Reading |
| 📋 **قالب‌ها** | 5 ساختار داستانی آماده |
| 💻 **ابزار خط فرمان** | رابط کامل خط فرمان |
| 📖 **مستندات** | انگلیسی و فارسی |
| 🔄 **سازگاری** | کدهای نسخه 1 بدون تغییر کار می‌کنند |
